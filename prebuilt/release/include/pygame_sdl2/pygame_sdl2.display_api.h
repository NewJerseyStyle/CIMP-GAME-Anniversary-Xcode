...
static int import_pygame_sdl2__display(void) {
  PyObject *module = 0;
  module = __Pyx_ImportModule("pygame_sdl2.display");
  if (!module) goto bad;
  if (__Pyx_ImportFunction(module, "PyWindow_AsWindow", (void (**)(void))&__pyx_api_f_11pygame_sdl2_7display_PyWindow_AsWindow, "SDL_Window *(PyObject *)") < 0) goto bad;
